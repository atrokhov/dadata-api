...
RSpec.describe "Users", type: :request do
  ...
  describe "PATCH /update" do
    ...
    it "returns http found, redirect to edit current user, update current user if user is client" do
        user1 = User.create(email: 'test@test.com', password: "password", password_confirmation: "password", role: :client, full_name: "Атрохов Артур Эдуардович")
        sign_in user1
        form_params = { user: { full_name: "Атрохов Артур Иванович" } }
    ...
    it "returns http found, redirect to edit current user, update any user if user is admin" do
        user1 = User.create(email: 'test@test.com', password: "password", password_confirmation: "password", role: :admin, full_name: "Атрохов Артур Эдуардович")
        user2 = User.create(email: 'test2@test.com', password: "password", password_confirmation: "password", role: :client, full_name: "Атрохова Янита")
        sign_in user1
        form_params = { user: { full_name: "Атрохов Артур Иванович" } }
        patch "/users/#{user2.id}", params: form_params
